...
public class AABB {
	...
	public AABB setFromPoints(List<Vec3> points) {
		return setFromPoints(points, new Vec3(), new Quaternion(), 0);
	}
	 ...
	 */
	public AABB setFromPoints(List<Vec3> points, Vec3 position, Quaternion quaternion, double skinSize) {
		Vec3 l = this.lowerBound;
		Vec3 u = this.upperBound;
	...
	public boolean overlaps(AABB aabb) {
		Vec3 l1 = this.lowerBound;
		Vec3 u1 = this.upperBound;
	...
	public AABB toLocalFrame(Transform frame, AABB target) {
		...
		return target.setFromPoints(Arrays.asList(corners));
		// return target;
	}
	...
	public boolean overlapsRay(Ray ray) {
		...
		// this.lowerBound is the corner of AABB with minimal coordinates - left bottom,
